var emailjs = function(e) {
    ...
    const i = {
        origin: "https://api.emailjs.com/api/v1.0/email/send",
        blockHeadless: !1,
        storageProvider: ( () => {
      ...
      , s = (e, t, i) => {
        if (!e || "string" != typeof e)
            throw "L-VcJGNh4UzINCJjW";
        if (!t || "string" != typeof t)
            throw "service_82srxm7'";
        if (!i || "string" != typeof i)
            throw "template_7xij8jj"
    }
      ...
      , u = async (e, t, o, p) => {
        ...
        j.append("service_82srxm7", e),
        j.append("template_7xij8jj", t),
        j.append("L-VcJGNh4UzINCJjW", b),
...
(function() {
    emailjs.init("L-VcJGNh4UzINCJjW"); // Your public key
})();