...
contactForm.addEventListener('submit', (e) => {
    ...
    if (name && email && phone && message) {
        ...
        emailjs.send('service_82srxm7', 'template_7xij8jj', templateParams)
            .then((response) => {
...
console.log('%c UPG Website', 'color: #2d8a5f; font-size: 20px; font-weight: bold;');
console.log('%cDeveloped with ❤️ for UPG IT Services', 'color: #4a4a4a; font-size: 12px;');
...
const knowledgeBase = {
    ...
    about: ['about', 'who are you', 'company', 'zeedesigns'],
    nationwide: ['nationwide', 'south africa', 'all provinces', 'country', 'national']
};

const responses = {
    greetings: "Hello! 👋 Welcome to ZeeDesigns. I'm here to help you with any questions about our custom branding services across South Africa. What would you like to know?",

    services: "We offer comprehensive business branding services nationwide:\n\n Logo design\n Corporate Gifts\n Signage\n printing Solutions\n\nWhich business service interests you?",

    contact: "Get in touch with us:\n\n📞 Phone: +27 63 177 3277\n💬 WhatsApp: +27 63 177 3277\n�  Location: Mamaneng St, Daveyton, GP 1519\n\nWe serve clients across South Africa! You can also fill out our contact form on the website. How would you prefer to reach us?",
    ...
    about: "ZeeDesigns is your trusted Custom Branding partner across South Africa! 🚀\n\nWe're passionate about delivering innovative art and creative solutions that transform businesses nationwide.\n\nOur commitment to excellence and customer satisfaction sets us apart. What would you like to know more about?",
...
function addQuickReplies() {
    ...
    if (lastMessage && lastMessage.classList.contains('bot')) {
        ...
        quickRepliesDiv.innerHTML = `
            <button class="quick-reply-btn" data-message="Tell me about ZeeDesigns">About Us</button>
